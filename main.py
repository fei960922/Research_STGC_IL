...
def main():
    ...
    parser.add_argument('-net_type', type=str, default='STG_5_demo_5', help='Net type')
    ...
    parser.add_argument('-log_step', type=int, default=5, help='number of steps to output synthesized image')
